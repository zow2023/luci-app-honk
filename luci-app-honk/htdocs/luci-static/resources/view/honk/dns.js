...
// luci-app-honk DNS page (modified 2026-08-31)
// 改动：与 global.js 同，新增 tryExecService + handleReloadService + formatCode 修复 try/catch 缺失。
...
return view.extend({
    ...
    render: function (data) {
        var self = this;
        var content = (data && typeof data === 'string') ? data : (data && data.content) || '';
